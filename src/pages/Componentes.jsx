...
export function Componentes() {
    ...
    return (
        <div>
            <Header />
            {/* bg-[#0C0C0C] */}
            <div id="pagina" className="bg-white text-white pt-[4rem] flex flex-col items-center px-[1.5rem] mt-[4rem] dark:bg-[#0C0C0C] w-[100vw] lg:w-full">
                <CompComponentes />
                ...
                <div id="comprar" className="flex flex-col lg:grid lg:grid-cols-3 lg:gap-[1rem]">
                    ...
                    <div id="produto2" className="border-[4px] border-[#0C0C0C]  h-[40rem] bg-white mb-[1rem]">
                        ...
                        <h2 className="text-[#0C0C0C] text-[1.6rem] flex justify-center text-center mb-[.3rem] font-bold lg:text-[2rem]" >Carcaça para Membrana</h2>
                    ...
                    <div id="produto3" className="border-[4px] border-[#0C0C0C] h-[40rem] bg-white mb-[1rem]">
                        ...
                        <h2 className="text-[#0C0C0C] text-[1.8rem] flex justify-center text-center mb-[.3rem] font-bold lg:text-[2rem]">Controlador de Carga</h2>
