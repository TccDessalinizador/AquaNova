    ...
    return (
        <div class="flex flex-col ">
            <div className="pagina">
                <img src={LogoSite} alt="logo do site" class="flex self-center justify-center w-[10rem] h-[10rem] mb-[2rem]" />

                <form action="" class="flex flex-col px-[1.5rem]">
                    <label htmlFor="nome" class="text-3x1 mx-[0.5rem] font-display">Nome</label>
                    <input type="text" placeholder="Nome e Sobrenome" id="nome" class="mb-[2.85rem] h-[3.35rem] w-100% bg-[#D9D9D9] rounded-[1.125rem] px-[1rem]" />

                    <label htmlFor="email" class="text-3x1 mx-[0.5rem] font-display">Email</label>
