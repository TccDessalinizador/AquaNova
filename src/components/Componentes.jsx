    ...
    return (
        <div>
            ...
            <div id="pagina" class="bg-[#0C0C0C] text-white pt-[4rem] flex flex-col items-center px-[1.5rem]">
                ...
                <div id="lista" class="flex flex-col lg:flex-row lg:gap-[50rem] w-[100%] mb-[2rem] lg:mb-[10rem]">
                ...
                <div id="comprar" class="flex flex-row lg:grid lg:grid-cols-3 lg:gap-[1rem]">
                    ...
                    <div id="produto1" class=" h-[40rem] bg-white mb-[1rem] items-center">
                    ...
                    <div id="produto2" class=" h-[40rem] bg-white mb-[1rem]">
                    ...
                    <div id="produto3" class="h-[40rem] bg-white mb-[1rem]">
                    ...
                    <div id="produto4" class="h-[40rem] bg-white mb-[1rem]">
                    ...
                    <div id="produto5" class="h-[40rem] bg-white mb-[1rem]">
                    ...
                    <div id="produto6" class="h-[40rem] bg-white mb-[1rem]">
