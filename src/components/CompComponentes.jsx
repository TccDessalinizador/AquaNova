...
export function CompComponentes() {
    ...
    return (
        <div id="componentes" className="bg-white text-white flex flex-col items-center px-[1.5rem] mt-[3rem] dark:bg-[#0C0C0C]">
            <div id="top" class="mb-[2rem] flex flex-col justify-end text-[#0C0C0C] lg:w-[100vw] w-[22rem]">
            ...
            <div class="flex flex-col items-center mb-[3rem] text-[#0C0C0C]">
                ...
                <h2 class="text-[1.5rem] pl-[1.5rem] lg:text-[2rem] font-inter font-bold dark:text-white ml-[2.8rem] lg:ml-0">e quanto será seu investimento</h2>
            </div>
